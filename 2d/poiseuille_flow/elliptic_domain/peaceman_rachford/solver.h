#ifndef POISEUILLE_FLOW_ELLIPTIC_DOMAIN_PEACEMAN_RACHFORD_SOLVER_H
#define POISEUILLE_FLOW_ELLIPTIC_DOMAIN_PEACEMAN_RACHFORD_SOLVER_H
...
namespace PoiseuilleFlow::EllipticDomain::PeacemanRachford {
    class Solver {
        private:
            double nu;
