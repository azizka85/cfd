#ifndef POISEUILLE_FLOW_ELLIPTIC_DOMAIN_CRANCK_NICOLSON_SOLVER_H
#define POISEUILLE_FLOW_ELLIPTIC_DOMAIN_CRANCK_NICOLSON_SOLVER_H
...
namespace PoiseuilleFlow::EllipticDomain::CranckNicolson {
    class Solver {
        private:
            double nu;
