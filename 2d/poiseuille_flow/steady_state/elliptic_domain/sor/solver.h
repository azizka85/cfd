#ifndef POISEUILLE_FLOW_STEADY_STATE_ELLIPTIC_DOMAIN_SOR_SOLVER_H
#define POISEUILLE_FLOW_STEADY_STATE_ELLIPTIC_DOMAIN_SOR_SOLVER_H
...
namespace PoiseuilleFlow::SteadyState::EllipticDomain::SOR {
    class Solver {
        private:
            double g;
            double nu;
