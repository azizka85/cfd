#ifndef POISEUILLE_FLOW_STEADY_STATE_TRIANGULAR_DOMAIN_SOR_SOLVER_H
#define POISEUILLE_FLOW_STEADY_STATE_TRIANGULAR_DOMAIN_SOR_SOLVER_H
...
namespace PoiseuilleFlow::SteadyState::TriangularDomain::SOR {
    class Solver {
        private:
            double g;
            double nu;
