#ifndef POISEUILLE_FLOW_STEADY_STATE_TRIANGULAR_DOMAIN_FREE_SURFACE_RICHARDSON_SOLVER_H
#define POISEUILLE_FLOW_STEADY_STATE_TRIANGULAR_DOMAIN_FREE_SURFACE_RICHARDSON_SOLVER_H
...
namespace PoiseuilleFlow::SteadyState::TriangularDomain::FreeSurface::Richardson {
    class Solver {
        private:
            double a;
