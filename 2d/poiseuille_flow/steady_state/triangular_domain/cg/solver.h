#ifndef POISEUILLE_FLOW_STEADY_STATE_TRIANGULAR_DOMAIN_CG_SOLVER_H
#define POISEUILLE_FLOW_STEADY_STATE_TRIANGULAR_DOMAIN_CG_SOLVER_H
...
namespace PoiseuilleFlow::SteadyState::TriangularDomain::CG {
    class Solver {
        private:
            double g;
            double nu;
