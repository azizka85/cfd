#ifndef POISEUILLE_FLOW_STEADY_STATE_TRIANGULAR_DOMAIN_RICHARDSON_SOLVER_H
#define POISEUILLE_FLOW_STEADY_STATE_TRIANGULAR_DOMAIN_RICHARDSON_SOLVER_H
...
namespace PoiseuilleFlow::SteadyState::TriangularDomain::Richardson {
    class Solver {
        private:
            double g;
            double nu;
