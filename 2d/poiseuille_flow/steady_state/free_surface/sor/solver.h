#ifndef POISEUILLE_FLOW_STEADY_STATE_FREE_SURFACE_SOR_SOLVER_H
#define POISEUILLE_FLOW_STEADY_STATE_FREE_SURFACE_SOR_SOLVER_H
...
namespace PoiseuilleFlow::SteadyState::FreeSurface::SOR {
    class Solver {
        private:
            double dx;
            double dy;
