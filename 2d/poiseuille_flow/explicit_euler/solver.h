#ifndef POISEUILLE_FLOW_EXPLICIT_EULER_SOLVER_H
#define POISEUILLE_FLOW_EXPLICIT_EULER_SOLVER_H
...
namespace PoiseuilleFlow::ExplicitEuler {
    class Solver {
        private:
            double nu;
            double dx;
            ...
            void setInitialCondition(int nx, int ny, vector<vector<double>>& w);
            void setBoundaryCondition(int nx, int ny, vector<vector<double>>& w);            
