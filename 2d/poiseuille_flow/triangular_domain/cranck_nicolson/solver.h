#ifndef POISEUILLE_FLOW_TRIANGULAR_DOMAIN_CRANCK_NICOLSON_SOLVER_H
#define POISEUILLE_FLOW_TRIANGULAR_DOMAIN_CRANCK_NICOLSON_SOLVER_H
...
namespace PoiseuilleFlow::TriangularDomain::CranckNicolson {
    class Solver {
        private:
            double nu;
