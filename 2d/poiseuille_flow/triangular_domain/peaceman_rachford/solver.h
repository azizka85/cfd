#ifndef POISEUILLE_FLOW_TRIANGULAR_DOMAIN_PEACEMAN_RACHFORD_SOLVER_H
#define POISEUILLE_FLOW_TRIANGULAR_DOMAIN_PEACEMAN_RACHFORD_SOLVER_H
...
namespace PoiseuilleFlow::TriangularDomain::PeacemanRachford {
    class Solver {
        private:
            double nu;
