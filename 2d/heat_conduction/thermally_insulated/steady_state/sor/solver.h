#ifndef HEAT_CONDUCTION_THERMALLY_INSULATED_STEADY_STATE_SOR_SOLVER_H
#define HEAT_CONDUCTION_THERMALLY_INSULATED_STEADY_STATE_SOR_SOLVER_H
...
namespace HeatConduction::ThermallyInsulated::SteadyState::SOR {
    class Solver {
        private:
            double l;
            double h;
