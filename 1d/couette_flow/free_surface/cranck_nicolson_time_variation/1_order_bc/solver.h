#ifndef COUETTE_FLOW_FREE_SURFACE_CRANCK_NICOLSON_TIME_VARIATION_1_ORDER_BC_SOLVER_H
#define COUETTE_FLOW_FREE_SURFACE_CRANCK_NICOLSON_TIME_VARIATION_1_ORDER_BC_SOLVER_H
...
namespace CouetteFlow::FreeSurface::CranckNicolsonWithTimeVariation::FirstOrderBC {
    class Solver {
        private:
            double uBottom;
            double nu;
