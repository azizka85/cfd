#ifndef INVISCID_BURGERS_TVD_IMPLICIT_SOLVER_H
#define INVISCID_BURGERS_TVD_IMPLICIT_SOLVER_H
...
namespace InviscidBurgers::TVD::Implicit {
    class Solver {
        private:
            double l;
            double dx;
        ...
        public:
            Solver(double l, double dx, double a, double epsilon, double endTime, double outputTimeStep, string dir);
