#ifndef INVISCID_BURGERS_BEAM_WARMING_SOLVER_H
#define INVISCID_BURGERS_BEAM_WARMING_SOLVER_H
...
namespace InviscidBurgers::BeamWarming {
    class Solver {
        private:
            double l;
            double dx;
            ...
            void calculateRHS(int nx, double dt, vector<double>& u, vector<double>& d);
