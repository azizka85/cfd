#ifndef INVISCID_BURGERS_STEP_UPWIND_CONSERVATIVE_SOLVER_H
#define INVISCID_BURGERS_STEP_UPWIND_CONSERVATIVE_SOLVER_H
...
namespace InviscidBurgers::Step::Upwind::Conservative {
    class Solver {
        private:
            double l;
            double dx;
