#ifndef LINEAR_ADVECTION_EXPLICIT_EULER_SOLVER_H
#define LINEAR_ADVECTION_EXPLICIT_EULER_SOLVER_H
...
namespace LinearAdvection::ExplicitEuler {
    class Solver {
        private:
            double u;
            double d;
            ...
            void setBoundaryCondition(int nx, vector<double>& C);            
